...
voltage, current, th, ref = neuron.dynamics(quantized_weight * spike_input)
...
class TestALIF(unittest.TestCase):
    ...
    def test_persistent_state(self):
        ...
        voltage0, current0, th0, ref0 = neuron.dynamics(
            quantized_weight[..., :ind] * spike_input[..., :ind]
        )
        spike0 = neuron.spike(voltage0, th0, ref0)
        voltage1, current1, th1, ref1 = neuron.dynamics(
            quantized_weight[..., ind:] * spike_input[..., ind:]
        )
