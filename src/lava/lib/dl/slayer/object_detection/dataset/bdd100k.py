...
class _BDD(Dataset):
    def __init__(self,
        ...
        if not os.path.isdir(self.label_path):
            ...
            msg += 'Download "MOT 2020 labels" from https://bdd-data.berkeley.edu/portal.html#download'
        ...
        if not os.path.isdir(self.image_path):
            ...
            msg += 'Download "MOT 2020 Images" from https://bdd-data.berkeley.edu/portal.html#download'
            raise FileNotFoundError(msg)
...
if __name__ == '__main__':
    train_set = BDD(root='/home/lecampos/data/bdd100k',
                    dataset='track', train=True, augment_prob=1.0)
